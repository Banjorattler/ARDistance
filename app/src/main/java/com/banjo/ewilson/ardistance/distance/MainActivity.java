...
package com.banjo.ewilson.ardistance.distance;
...
import com.banjo.ewilson.ardistance.R;
...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        try {
            ...
            virtualObject.createOnGlThread(/*context=*/ this, "models/waypoint.obj", "models/waypoint_color.png");
    ...
    private void printResult(final String result) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                textViewDistance.setText(result);
            }
        });
    }
